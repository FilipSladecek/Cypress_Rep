...
describe("Test set for academy",        {
    ...
    it('Akademia testing aplikacie-3', () => { 
        ...
        cy.get(".alert-warning")
        .should("contain.text", "Your shopping cart is empty.") // => {Očakávam že sa daná objednávka odstráni z košíka a vypíše sa "Your shopping cart is empty."} --------REVIEW -- Správa
    });
...
//Review -- Správa: V treťom teste, riadok 82 -- očakávanie by sa mohlo mohlo presunúť z test stepu na riadku 82 do riadku 85, kde je riadok v kóde napísané čo sa očakáva. Niektoré should('be.visible') sú možno zbytočné, ale na funkčnosť by to nemalo mať vplyv.